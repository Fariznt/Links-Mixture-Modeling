...
## Note that results directly from stan model are not usable as they may have labels switched. 
## instead we post-process them first and compute posterior means, variances and confidence limits manually.
